module.exports = function(RED) {
  function Corenode-red-contrib-ozwFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("node-red-contrib-ozw.label.statusset") });
  ...
  RED.nodes.registerType("node-red-contrib-ozw", Corenode-red-contrib-ozwFunctionality);
